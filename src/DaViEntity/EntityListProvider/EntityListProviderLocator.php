...
class EntityListProviderLocator extends AbstractLocator {
  ...
  public function getEntityListProvider(string | EntityInterface $entityClass): EntityListProviderInterface {
    $class = $this->entityTypeAttributesReader->getEntityListProviderClass($entityClass);

    if($this->has($class)) {
      return $this->get($class);
    } else {
      return $this->get(NullEntityListProvider::class);
    }
  }
